...
if __name__ == "__main__":
    ...
    """
    if len(sys.argv) != 2:
        logging.error("Invalid arguments. Usage: python siri_etl.py [extract|transform]")
        raise Exception("Invalid arguments. Usage: python siri_etl.py [extract|transform]")
